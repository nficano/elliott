...
import { canonicalJson, decodeUnknown, sha256Text } from "../../runtime/wire";
...
beforeEach(() => {
  Bun.env["ELLIOTT_DARWIN_FIXTURE"] = "1";
...
describe("benchmark runner", () => {
  test("runs a bound benchmark fixture", async () => {
    const result = await runBenchmark(await fixture("benchmark.json"));
