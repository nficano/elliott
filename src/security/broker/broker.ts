...
import type { Capability, GrantSet } from "../grants/types";
...
export const findGrantedCapability = (
  ...
  grantSet.capabilities.find((candidate) =>
    candidate.capability === capability
    && candidate.resources.some((allowed) => resourceAllowed(allowed, resource))
  );
...
export class CapabilityBroker {
  ...
  #materialize(
    ...
    const capability = findGrantedCapability(
      grantSet,
      input.capability,
      input.resource,
    );
