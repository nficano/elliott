...
export const slackMessageTool = (settings: SlackSettings): ToolDefinition => ({
  name: "slack_message",
  description:
    ...
    + "target elsewhere. See docs/slack-llms.txt for the block catalog, "
    + "interactivity, and formatting rules.",
