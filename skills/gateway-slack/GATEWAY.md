...
The full block catalog, interactivity/response rules, file handling, and the
mrkdwn-vs-markdown reference live in `docs/slack-llms.txt`; consult it before
building an unfamiliar block.
