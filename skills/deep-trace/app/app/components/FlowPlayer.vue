    ...
    >
      <div class="mb-2xs flex items-center gap-xs">
        ...
        <div class="ml-auto flex gap-3xs">
          ...
          >
            <svg aria-hidden="true" class="icon" fill="currentColor" viewBox="0 0 640 640">
          ...
          >
            <svg v-if="flowUi.playing" aria-hidden="true" class="icon" fill="currentColor" viewBox="0 0 640 640">
            ...
            <svg v-else aria-hidden="true" class="icon" fill="currentColor" viewBox="0 0 640 640">
