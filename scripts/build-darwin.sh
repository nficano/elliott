...
artifact_root="${1:-${repository_root}/.artifacts/darwin}"
platform="${ELLIOTT_DARWIN_PLATFORM:-linux/arm64}"
...
build_image "evaluator-dspy" "darwin/optimizers/dspy/Dockerfile"
build_image "evaluator-darwinian" "darwin/optimizers/darwinian/Dockerfile"
build_image \
